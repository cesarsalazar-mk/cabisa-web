      ...
      <div style={staticSectionStyle}>
        <Row gutter={16} className={'margin-top-15'}>
          <Col xs={24} sm={12} md={8} lg={4}>
            <Search
              key={`payment-note-${props.filtersResetKey}`}
          ...
          <Col xs={24} sm={12} md={8} lg={4}>
            <Search
              key={`payment-doc-${props.filtersResetKey}`}
              prefix={<SearchOutlined className={'cabisa-table-search-icon'} />}
          ...
          <Col xs={24} sm={12} md={8} lg={4}>
            <Search
              key={`payment-name-${props.filtersResetKey}`}
              prefix={<SearchOutlined className={'cabisa-table-search-icon'} />}
          ...
          <Col xs={24} sm={12} md={8} lg={4}>
            <DatePicker
              key={`payment-date-${props.filtersResetKey}`}
          ...
          <Col xs={24} sm={12} md={8} lg={4}>
            <Select
              key={`payment-credit-${props.filtersResetKey}`}
              className={'single-select'}
